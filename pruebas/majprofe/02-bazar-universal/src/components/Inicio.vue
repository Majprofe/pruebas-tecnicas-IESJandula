<template>
    <main class="flex flex-col items-center justify-center h-screen">
        <img :src="caravana" alt="Caravana icon">
        <h1 class="text-4xl font-bold mb-4">Bazar Online</h1>
        <form class="flex flex-col items-center" @submit.prevent="search">
            <div class="flex items-center leading-7 relative max-w-190 m-4">
        ...
        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full shadow-lg">Buscar</button>
        </form>
